...
public class RestaurantGui extends JFrame implements ActionListener{
	...
	//private JButton nonNormatives = new JButton("Non Normatives");
	...
	//nonNormatives.addActionListener(this);
	...
	//getContentPane().add(nonNormatives);
	...
	/*else if(e.getSource() == nonNormatives)
	{
